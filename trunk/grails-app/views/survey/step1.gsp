...
<%--                                    <g:message code="survey.addr_zipcode.label" default="Addrzipcode" />: <g:textField name="addr_zipcode" value="${surveyInstance?.addr_zipcode}" onkeyup="postcode_validate(this.value, document.getElementById('status'));"/> <span id="status"></span> --%>
                ...
                <div class="buttons">
                <%--
                    <span class="button"><g:submitButton name="create" class="save" value="${message(code: 'button.save-finish-later.label', default: 'save')}" /></span>
                    <span class="button"><input type="reset" value="${message(code: 'button.reset-all.label', default: 'reset')}"></span>  
                    <span class="button"><g:actionSubmit class="next" action="step2_after_save" value="${message(code: 'button.save-then-go-to-next.label', default: 'step2_after_save')}" /></span>
                 --%>    
                    ...
                    <span class="button"><g:actionSubmit class="next" action="update_unified" value="${message(code: 'button.save-then-go-to-next.label', default: 'next')}"  onclick="DisableEnableForm(document.surveyform,false);" /></span>
                    <span class="menuButton"><g:render template="/common/step_meter"/></span>
                </div>
            </g:form>
        </div>
