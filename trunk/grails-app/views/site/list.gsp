                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="fourletters" title="${message(code: 'site.fourletters.label', default: 'Fourletters')}" />
                        
                            <g:sortableColumn property="location" title="${message(code: 'site.location.label', default: 'Location')}" />
                    ...
                    <g:each in="${siteInstanceList}" status="i" var="siteInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: siteInstance, field: "fourletters")}</td>
                        
                            <td>${fieldValue(bean: siteInstance, field: "location")}</td>
