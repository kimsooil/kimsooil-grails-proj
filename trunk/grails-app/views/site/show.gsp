            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="site.fourletters.label" default="Fourletters" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: siteInstance, field: "fourletters")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="site.location.label" default="Location" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: siteInstance, field: "location")}</td>
