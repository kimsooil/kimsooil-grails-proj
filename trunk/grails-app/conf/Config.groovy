...
log4j = {
	...
	appenders {
		console name:'stdout'
		rollingFile  name:'logfile', file: "./logs" + '/HispanicBioBank.log', threshold: org.apache.log4j.Level.INFO, maxFileSize:"1MB", maxBackupIndex: 10, 'append':true
