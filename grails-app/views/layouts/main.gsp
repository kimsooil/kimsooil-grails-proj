...
//);
    ...
    <body>
        ...
        <td>
	        ...
	        <label>Hispanic Bio-Bank (6/17/2011 - <a href="/hispbb/changes.html">Changes</a>)</label> - <label>(<a href="/hispbb/browsers.html">Best viewed with Safari & FireFox - <font color="red">not IE</font></a>)</label>
        </td>
        <td>
