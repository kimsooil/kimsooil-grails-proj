                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="activities"><g:message code="survey.activities.label" default="Activities" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'activities', 'errors')}">
                                    <g:select name="activities" from="${u56survey.PhysicalActivity.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.activities*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="alcohols"><g:message code="survey.alcohols.label" default="Alcohols" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'alcohols', 'errors')}">
                                    <g:select name="alcohols" from="${u56survey.AlcoholUse.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.alcohols*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="breast_cancers"><g:message code="survey.breast_cancers.label" default="Breastcancers" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'breast_cancers', 'errors')}">
                                    <g:select name="breast_cancers" from="${u56survey.BreastCancer.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.breast_cancers*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="breastfeed"><g:message code="survey.breastfeed.label" default="Breastfeed" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'breastfeed', 'errors')}">
                                    <g:select name="breastfeed" from="${u56survey.BreastFeed.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.breastfeed*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="cancers"><g:message code="survey.cancers.label" default="Cancers" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'cancers', 'errors')}">
                                    <g:select name="cancers" from="${u56survey.CancerHistory.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.cancers*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="exposures"><g:message code="survey.exposures.label" default="Exposures" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'exposures', 'errors')}">
                                    <g:select name="exposures" from="${u56survey.OccupationalExposure.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.exposures*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="family_cancers"><g:message code="survey.family_cancers.label" default="Familycancers" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'family_cancers', 'errors')}">
                                    <g:select name="family_cancers" from="${u56survey.FamilyCancer.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.family_cancers*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="former_medications"><g:message code="survey.former_medications.label" default="Formermedications" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'former_medications', 'errors')}">
                                    <g:select name="former_medications" from="${u56survey.FormerMedication.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.former_medications*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="psycho_problems"><g:message code="survey.psycho_problems.label" default="Psychoproblems" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'psycho_problems', 'errors')}">
                                    <g:select name="psycho_problems" from="${u56survey.PsychologyProblem.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.psycho_problems*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="radiation_exposures"><g:message code="survey.radiation_exposures.label" default="Radiationexposures" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'radiation_exposures', 'errors')}">
                                    <g:select name="radiation_exposures" from="${u56survey.RadiationExposure.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.radiation_exposures*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="saturated_fats"><g:message code="survey.saturated_fats.label" default="Saturatedfats" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'saturated_fats', 'errors')}">
                                    <g:select name="saturated_fats" from="${u56survey.SaturatedFat.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.saturated_fats*.id}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="tobaccos"><g:message code="survey.tobaccos.label" default="Tobaccos" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'tobaccos', 'errors')}">
                                    <g:select name="tobaccos" from="${u56survey.TobaccoUse.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.tobaccos*.id}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="vegetables"><g:message code="survey.vegetables.label" default="Vegetables" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: surveyInstance, field: 'vegetables', 'errors')}">
                                    <g:select name="vegetables" from="${u56survey.Vegetable.list()}" multiple="yes" optionKey="id" size="5" value="${surveyInstance?.vegetables*.id}" />
                                </td>
                            </tr>
